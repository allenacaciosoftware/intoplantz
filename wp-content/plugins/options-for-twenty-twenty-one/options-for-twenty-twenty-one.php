...
if (class_exists('woocommerce')) {
            ...
            $control_label = __('Enable Privacy Link', 'options-for-twenty-twenty-one');
            $control_description = sprintf(wp_kses(__('Injects link to the privacy policy page set in <a href="%s">Privacy Settings</a>.', 'options-for-twenty-twenty-one'), array('a' => array('href' => array()))), esc_url(admin_url('options-privacy.php')));
            ofttoCommon::add_hidden_control($wp_customize, 'privacy_link', 'oftto_footer', $control_label, $control_description . ' ' . $upgrade_nag);

...
class Admin
{
    ...
    public function outOfStockVisibilityCallback()
    {
        ...
        $this->fileManager->includeTemplate( 'admin/fields/out-of-stock-visibility.php', [
    ...
    public function templateRewriteCallback()
    {
        ...
        $this->fileManager->includeTemplate( 'admin/fields/product-searchform.php', [
    ...
    public function setSettings()
    {
        ...
        $defaultSettings = [
            ...
            SearchPlugin::OPTIONS['autocompleteFields'] => [
            'image' => true,
            'price' => true,
            'btn'   => false,
        ],
    ...
    public function removeFooterAdmin( $text )
    {
        ...
        $premmercePages = [ 'premmerce_page_premmerce-search-admin' ];

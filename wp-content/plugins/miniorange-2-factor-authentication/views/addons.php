...
<div id="mo_addon_features_only" style="margin-top: 3%;">	
    ...
    background-color: white;width: 30%;margin: 10px">
                ...
                <div style="text-align: center;">
						...
						{
							?>
	                         <button class="button button-primary button-large " onclick="mo2f_upgradeform('wp_2fa_addon_rba', 'addon_plan')" >Purchase</button>
			                <?php 
			            }else
			            { ?>
							<button class="button button-primary button-large " onclick="mo2f_register_and_upgradeform('wp_2fa_addon_rba', 'addon_plan')" >Purchase</button>
			                <?php 
			            } 
			                ?>
		    	</div>

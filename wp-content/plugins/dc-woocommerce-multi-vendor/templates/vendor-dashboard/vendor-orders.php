...
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-header" style="margin-bottom: 20px;"><h2>Order Items I sold</h2></div>
    ...
    <div class="panel panel-default">
        <div class="panel-header" style="margin-bottom: 20px;"><h2>Order Items I bought</h2></div>
        <div class="panel-body">
